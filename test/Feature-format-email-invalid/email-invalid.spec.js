...
test('email invalid', async ({page}) => {  
    ...
    await page.getByPlaceholder('Masukan email').fill('test123@i');
    ...
    await expect(page.locator('.email-error')).toHaveText('Kolom email harus berupa alamat email yang valid.');
});
